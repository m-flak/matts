...
public class RelationshipParameter : IConstrainedParameter
{
    public bool ConstraintValid { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
    ...
    public Cardinality Cardinality { get; set; } = Cardinality.UNIDIRECTIONAL;
    public FieldNameValue? OnRelationsipParameter { get; set; }
