 ...
 *
 * THIS FILE ORIGINALLY: CSP Helper from https://github.com/indice-co/Indice.AspNet/blob/develop/src/Indice.AspNetCore/Middleware/CSP.cs
 * Copyright (c) 2022-2023 Indice-Co <company@indice.gr>
 *
...
public class CSP : IEnumerable<string>, ICloneable
{
    ...
    /// <summary>Allows loading resources from the same origin (same scheme, host and port).</summary>
    ...
    /// <summary>Allows loading resources via the data scheme (eg. Base64 encoded images).</summary>
    ...
    /// <summary>Appends an entry to the current CSP policy at the specified key (ie script-src etc.).</summary>
    ...
    /// <summary>The string representation of the CSP header value. Ready to use.</summary>
    /// <returns></returns>
