...
public interface IWebsocketHandler<EMsgTypes, TMessage> : IDisposable where EMsgTypes : struct, Enum where TMessage : class
{
    WebSocket? Websocket { get; set; }
    CancellationToken WebsocketCancellation { get; set; }
