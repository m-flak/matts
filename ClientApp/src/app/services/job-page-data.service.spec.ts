...
describe('JobPageDataService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [],
      imports: [],
      providers: [{ provide: BackendService, useValue: FakeBackendService }, JobPageDataService],
    });
  ...
  it('should have the mutated applicants in the patch call', done => {
    ...
    const a = jobPageDataService
      .getJobByUuid('54991ebe-ba9e-440b-a202-247f0c33574f')
      .pipe(
  ...
  it('should mark a job dirty and remove the applicant relationship', done => {
    ...
    jobPageDataService
      .rejectApplicantFromJob('54991ebe-ba9e-440b-a202-247f0c33574f', 'db185379-70e8-4ec6-b5f7-370415ca3b43')
      .subscribe(() => {
        ...
        expect(jobPageDataService._getJob('54991ebe-ba9e-440b-a202-247f0c33574f')).toBeNull();
        expect(
          jobPageDataService.jobApplicants
            .get('54991ebe-ba9e-440b-a202-247f0c33574f')
            ?.has('db185379-70e8-4ec6-b5f7-370415ca3b43'),
        ).toBe(false);
        expect(
          jobPageDataService.getCurrentJob().applicants?.find(a => a.uuid === 'db185379-70e8-4ec6-b5f7-370415ca3b43'),
        ).toBeUndefined();
        done();
      });
  });
  ...
  it('should mark a job dirty and restore the applicant relationship', done => {
    ...
    jobPageDataService.jobApplicants
      .get('54991ebe-ba9e-440b-a202-247f0c33574f')
      ?.delete('db185379-70e8-4ec6-b5f7-370415ca3b43');

    jobPageDataService
      .rejectApplicantFromJob('54991ebe-ba9e-440b-a202-247f0c33574f', 'db185379-70e8-4ec6-b5f7-370415ca3b43', false)
      .subscribe(() => {
        expect(backendService.rejectForJob).toHaveBeenCalled();
